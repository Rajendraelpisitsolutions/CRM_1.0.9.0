      ...
      >
        ...
        <div className="px-4 py-3 border-t border-gray-200 flex items-center justify-between bg-gray-50 rounded-b-xl gap-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleApply}
              className="px-5 py-2 text-sm font-semibold bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-600 text-white rounded-lg transition-all shadow-sm hover:shadow-md"
            >
              Apply
            </button>
          </div>
