...
function Toast({ message, type, onDone }) {
  ...
  return (
    <div
      className={`fixed bottom-6 right-6 z-[999] flex items-center gap-3 px-5 py-3.5 rounded-xl shadow-lg
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-4">
          <div className="w-12 h-12 rounded-full border-4 border-gray-200 border-t-slate-700 animate-spin" />
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes ringPulse { 0%,100% { box-shadow:0 0 0 0 rgba(100,116,139,.30); } 60% { box-shadow:0 0 0 14px rgba(100,116,139,0); } }
      ...
      <div className="h-full overflow-y-auto bg-gray-50 animate-fade-in">
          ...
          <div className="px-8 py-8 flex flex-col sm:flex-row items-center sm:items-center gap-6">
            ...
            <div className="relative flex-shrink-0">
              <div
                className={`w-20 h-20 rounded-full bg-slate-100 flex items-center justify-center
                  text-slate-700 text-2xl font-semibold border-2 border-slate-200 shadow-sm select-none
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mt-2.5">
                ...
                {profile?.createdAt && (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs bg-white border border-gray-200 text-gray-500">
                    <FiCalendar size={10} />
            ...
            <div className="sm:self-center">
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 transition-colors"
              >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mx-6 mt-4">
          {[
            ...
            <div key={label}
              className="bg-white rounded-xl border border-gray-200 shadow-sm px-4 py-3.5 animate-scale-in
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mx-6 mt-5 pb-12">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden animate-scale-in">
            ...
            <form onSubmit={handleChangePassword} className="px-6 py-5 space-y-4">
              ...
              {/* Security tips */}
              <div className="mt-2 bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 space-y-1.5">
                <p className="text-[11px] font-semibold uppercase tracking-wider text-gray-400 mb-1">Password tips</p>
                {[
                  ...
                  <div key={tip} className="flex items-center gap-1.5 text-xs text-gray-500">
                    <FiCheck size={11} className="flex-shrink-0 text-gray-400" /> {tip}
                  </div>
                ))}
              </div>
            </form>
          ...
          <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden animate-scale-in">
            <div className="flex items-center gap-2.5 px-6 py-4 border-b border-gray-100">
              <div className="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center">
                <FiActivity size={15} className="text-gray-500" />
              </div>
