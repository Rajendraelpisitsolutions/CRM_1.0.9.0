...
const INPUT_CLS =
  "w-full h-10 px-3 rounded-lg border border-gray-200 bg-gray-50/60 text-sm text-gray-800 placeholder:text-gray-400 outline-none focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all";
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-5 py-4 border-t border-gray-100 bg-gray-50">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={handleApply} className="inline-flex items-center gap-1.5 px-5 py-2 text-sm font-semibold text-white bg-blue-500 hover:bg-blue-600 rounded-lg shadow-sm transition-colors">
