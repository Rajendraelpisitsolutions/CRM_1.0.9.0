...
function AddForms({
  ...
  const [contactFormData, setContactFormData] = useState({
    ...
    ImportID: "",
    Account: "",
    EnquiryNo: "", //EnquiryNo:"EITSPL-MKT-EQ-",
              ...
              <>
                <div className="space-y-1.5 md:col-span-2">
                  ...
                  <input
                    ...
                    disabled
                    readOnly
                    value={generateEnquiryNo ? "Will be auto-generated (e.g. EITSPL-MKT-EQ-003)" : "Not generated"}
    ...
    return (
      ...
      <form
        onSubmit={async (e) => {
          ...
          if (!isRequired(dealFormData.Priority || "")) validationErrors.Priority = "Priority is required";
          ...
          <FormSection title="Deal Information" id="dealinfo" isExpanded={expandedSectionsDeal.dealinfo} onToggle={toggleSectionDeal}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormSelect
                ...
                onChange={(e) => updateDealField("Priority", e.target.value)}
              >
                <option value="High">High</option>
                <option value="Medium">Medium</option>
                <option value="Low">Low</option>
              </FormSelect>
              {dealErrors.Priority && <div className="text-red-500 text-sm mt-1">{dealErrors.Priority}</div>}
            </div>
