    ...
    >
      ...
      <div className="relative">
        <button
          ...
          className="w-full flex items-center justify-between rounded-lg border border-gray-300 px-3 py-2 text-sm bg-white hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:outline-none"
        >
                        ...
                        <div key={deal.dealId || deal.id} className="group relative bg-white rounded-xl p-3 shadow-sm hover:shadow-md border border-gray-200 hover:border-gray-300 transition-all duration-200 overflow-hidden min-h-[200px] flex flex-col">
                          ...
                          {openMenuId === (deal.dealId || deal.id) && (
                            <div ref={dropdownRef} className="absolute top-9 right-2 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-20 min-w-36 animate-in fade-in zoom-in-95 duration-200">
                              <button onClick={() => { handleShowDetails(deal.dealId || deal.id); setOpenMenuId(null); }} className="w-full px-3 py-1.5 text-left text-xs text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-colors flex items-center gap-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                ...
                {!showAddNoteBox ? (
                  ...
                  <div className="space-y-3 animate-in fade-in duration-200">
                    ...
                    <AutoGrowTextarea
                      ...
                      className="w-full rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none px-3 py-2 text-sm"
                    />
              ...
              {noteEligibleContacts.length > 0 && (
                <div className="px-5 pt-3 pb-2 flex items-center gap-2 flex-wrap border-b">
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-full text-xs font-medium transition ${dealNotesContactFilter == null ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}
                  >
                    All
                  </button>
                  {noteEligibleContacts.map((c) => (
                    <button
                      ...
                      className={`px-3 py-1 rounded-full text-xs font-medium transition ${String(dealNotesContactFilter) === String(c.id) ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}
                    >
                      {c.name}
                    </button>
                  ))}
                          ...
                          <>
                            ...
                            <div className="flex gap-2 mt-3">
                              <button
                                ...
                                className="px-4 py-2 rounded-xl bg-blue-500 text-white text-sm">Save</button>
                              <button
            ...
            <div className="bg-white shadow-2xl w-[60%] h-full flex flex-col overflow-hidden animate-in slide-in-from-right duration-300 text-sm pointer-events-auto">
              <div className="flex flex-col gap-4 p-4 border-b border-gray-200/80 bg-white/80 backdrop-blur-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    className="px-2 sm:px-4 py-2 rounded-lg border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 text-sm font-medium transition-all duration-200 flex items-center justify-center gap-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                ...
                <form className="space-y-8" onSubmit={async (e) => {
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-5">
                          ...
                          <div className="flex flex-col gap-2"><label className="font-normal text-gray-700 text-sm">Priority <span className="text-red-500">*</span></label><div className="relative"><select required className="w-full rounded-xl pl-4 pr-10 py-3.5 text-gray-800 bg-gray-50 border-2 border-gray-200 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10 outline-none transition-all duration-150 appearance-none cursor-pointer" value={selectedDealDetails.priority || selectedDealDetails.Priority || ""} onChange={e => setSelectedDealDetails({ ...selectedDealDetails, priority: e.target.value })}><option value="High">High</option><option value="Medium">Medium</option><option value="Low">Low</option></select><svg className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg></div></div>
                  ...
                  <div className="flex justify-between items-center gap-3 pt-6 border-t-2 border-gray-200 mt-8 bg-white/50 backdrop-blur-sm rounded-xl p-6 -mx-2">
                    ...
                    {canEditDeal(selectedDealDetails) ? (
                      <button type="submit" className="px-6 py-3 rounded-lg bg-blue-500 hover:bg-blue-600 text-white font-medium shadow-sm transition-all duration-200 flex items-center gap-2 ml-auto focus:ring-2 focus:ring-blue-500 focus:outline-none">
                  ...
                  <div className="absolute top-0 right-0 z-40 h-full w-[30%] bg-white border-l border-gray-200 shadow-2xl overflow-hidden animate-in slide-in-from-right duration-300">
                    ...
                    <div className="p-6 h-full overflow-y-auto space-y-4">
                      <div className="flex justify-between items-center gap-3">
                        ...
                        <button type="button" onClick={() => setShowAddNoteBox(!showAddNoteBox)} className="px-3 py-2 rounded-xl bg-blue-500 hover:bg-blue-600 text-white text-sm transition">
                        ...
                        <div className="space-y-3 rounded-2xl border border-gray-200 bg-gray-50 p-4">
                          ...
                          <div className="flex gap-2">
                            <button
                              type="button"
                              onClick={handleSaveDealNote}
                              className="flex-1 py-2 rounded-xl bg-blue-500 hover:bg-blue-600 text-white text-sm"
                            >
                              Save Note
                            </button>
                            <button
                            ...
                            <div key={note.id || note.Id || index} className="rounded-2xl border border-gray-200 bg-gray-50 p-4">
                              ...
                              <div className="flex justify-between gap-3">
                                ...
                                <div className="flex flex-col gap-2 items-end">
                                  {editingNoteId === (note.id || note.Id) ? (
                                    <>
                                      <button type="button" onClick={() => handleUpdateNote(note)} className="text-xs px-3 py-1 rounded-lg bg-blue-500 text-white">Save</button>
